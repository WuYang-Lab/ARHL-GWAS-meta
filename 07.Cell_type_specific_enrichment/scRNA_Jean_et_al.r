#============================================================#
#
#  scRNA expression treatment of Philippe Jean
#
#============================================================#
...
SC = sc.read_h5ad("Jean_et_al.h5ad")
expr_df = SC.to_df()
...
dir <- "F:/Shi/ALL_of_my_Job/24-28 Ph.D WCHSCU/2_project_hearing loss/NC_revision/scDT/Jean"
dt <- fread(file.path(dir, "Sc_P8_12_20.txt"))
...
m2h <- fread(file.path(conf, "mouse_human_homologs_ensembl_mouse.txt"))
names(m2h) <- c("MumEN", "HumSYM")  

dat <- merge(dt, m2h, by.x="gene", by.y="MumEN")
...
setwd("F:/Shi/ALL_of_my_Job/24-28 Ph.D WCHSCU/2_project_hearing loss/NC_revision/scDT/Jean")
